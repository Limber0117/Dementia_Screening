...
FEATURE_MAP = [
    ...
    'age', 'jitter', 'shimmer', 'pause_ratio'
]
...
CANDIDATE_THRESHOLDS = [round(x * 0.01, 2) for x in range(40, 61)]
...
class MLAcousticBridge:
    ...
    def _score_to_category(self, score: float) -> str:
        ...
        if score >= RISK_THRESHOLDS['high']:
            return "HIGH RISK"
        elif score >= RISK_THRESHOLDS['moderate_high']:
            return "MODERATE-HIGH RISK"
        elif score >= RISK_THRESHOLDS['moderate_low']:
    ...
    def _score_to_level(self, score: float) -> str:
        """Convert group score to level description."""
        if score >= 0.60:
        ...
        for group_name, group_info in self.group_models.items():
            ...
            if available:
                ...
                group_scores[group_name] = {
                    ...
                    'confidence': 'low',  # Individual groups have low AUC
                }
    ...
    def generate_llm_prompt(self, patient_features: Dict[str, float],
        ...
        lines.append(f"    (Ensemble ML probability: {output['overall_score']:.1%})")
        lines.append("")
